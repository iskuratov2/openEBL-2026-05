...
from Ebeam_NicolasCasteleyn_michelson_TE1550_pcell import Michelson_TE1550_adiabatic as Michelson_TE1550 
...
visualize = True
delay_lengths = [50.0, 75.0, 100.0, 125.0, 150.0][:4]  # Desired delay lengths in micrometers
...
spacing_x = [130.0, 130.0, 140.0, 125]
...
circuit_name="EBeam_NicolasCasteleyn_v2B"
cell = i3.Circuit(
    name=circuit_name,
    specs=specs,
)
